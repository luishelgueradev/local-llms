...
**Plans:** 9 plans
- [ ] 14-01-PLAN.md — Migration 0005 atomic tuple (SQL + Drizzle schema + journal entry) [POL-04]
- [ ] 14-02-PLAN.md — Extend RegistrySchema with `policies` + per-entry `policy.cloud_allowed` [POL-01, POL-02]
- [ ] 14-03-PLAN.md — Add AllowlistViolationError, CloudNotAllowedError, InvalidScopedIdError + envelope mappings [POL-01, POL-02, POL-05]
- [ ] 14-04-PLAN.md — Implement applyPolicyGate helper + unit-test matrix [POL-01, POL-02]
- [ ] 14-05-PLAN.md — Wire applyPolicyGate into 5 routes + BLOCKING migration apply + breaker-spy integration test [POL-01, POL-02, POL-04, POL-05]
- [ ] 14-06-PLAN.md — scopedIdsPreHandler + agentId.child() extension + Pitfall-9 grep gate [POL-03, POL-05]
- [ ] 14-07-PLAN.md — Plumb scoped IDs through recordOutcome to request_log row + integration test [POL-04]
- [ ] 14-08-PLAN.md — Prometheus cardinality CI guard script + vitest [POL-06]
...
|-------|----------------|--------|-----------|
| 14. Policy Primitives + Tenant ID Foundation | 0/9 | Planned | - |
